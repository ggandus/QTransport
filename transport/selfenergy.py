...
class LeadSelfEnergy(_cpp.LeadSelfEnergy, InternalSelfEnergy):
    ...
    def __init__(self, hs_dii, hs_dij, hs_dim, eta=1e-4):
        ...
        # self.h_ij, s_ij = hs_dij # coupling between principal layers
    ...
    #     return self.impl.retarded(energy)
    ...
    #         delta = abs(v_01).max()
        ...
        # z = energy - self.bias + self.eta * 1.j
        #
        # h00 = z * self.s_ii.T.conj() - self.h_ii.T.conj()
        # h11 = h00.copy()
        # h10 = z * self.s_ij - self.h_ij
        # h01 = z * self.s_ij.T.conj() - self.h_ij.T.conj()
        #
