...
static CYTHON_INLINE void __pyx_f_13recursive_sgf_mat_copy(__pyx_t_double_complex, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static CYTHON_INLINE void __pyx_f_13recursive_sgf_mat_add(__pyx_t_double_complex, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static CYTHON_INLINE void __pyx_f_13recursive_sgf_init_vecs(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, struct __pyx_opt_args_13recursive_sgf_init_vecs *__pyx_optional_args); /*proto*/
static void __pyx_f_13recursive_sgf_get_Ginv(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
static PyObject *__pyx_pf_13recursive_sgf_get_G(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_G_kMM, PyObject *__pyx_v_H_kii, PyObject *__pyx_v_S_kii, PyObject *__pyx_v_H_kij, PyObject *__pyx_v_S_kij, PyObject *__pyx_v_energy, CYTHON_UNUSED PyObject *__pyx_v_eta, CYTHON_UNUSED PyObject *__pyx_v_bias); /* proto */
...
static CYTHON_INLINE void __pyx_f_13recursive_sgf_mat_copy(__pyx_t_double_complex __pyx_v_alpha, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b) {
  int __pyx_v_m;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_t_1;
 ...
 */
                        ...
                        *((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_b.data) + __pyx_t_9)) ) + __pyx_t_10 * __pyx_v_b.strides[1]) )) = __Pyx_c_prod_double(__pyx_v_alpha, (*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_a.data) + __pyx_t_7)) ) + __pyx_t_8 * __pyx_v_a.strides[1]) ))));
                      }
                  }
              }
          }
...
static CYTHON_INLINE void __pyx_f_13recursive_sgf_mat_add(__pyx_t_double_complex __pyx_v_alpha, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b) {
  int __pyx_v_m;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_t_1;
 ...
 */
                        ...
                        *((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_b.data) + __pyx_t_11)) ) + __pyx_t_12 * __pyx_v_b.strides[1]) )) = __Pyx_c_sum_double(__Pyx_c_prod_double(__pyx_v_alpha, (*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_a.data) + __pyx_t_7)) ) + __pyx_t_8 * __pyx_v_a.strides[1]) )))), (*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_b.data) + __pyx_t_9)) ) + __pyx_t_10 * __pyx_v_b.strides[1]) ))));
                      }
                  }
              }
          }
...
static CYTHON_INLINE void __pyx_f_13recursive_sgf_init_vecs(__Pyx_memviewslice __pyx_v_h_ii, __Pyx_memviewslice __pyx_v_s_ii, __Pyx_memviewslice __pyx_v_h_ij, __Pyx_memviewslice __pyx_v_s_ij, __Pyx_memviewslice __pyx_v_v_00, __Pyx_memviewslice __pyx_v_v_01, __Pyx_memviewslice __pyx_v_v_10, __Pyx_memviewslice __pyx_v_v_11, double __pyx_v_energy, struct __pyx_opt_args_13recursive_sgf_init_vecs *__pyx_optional_args) {
 ...
 */
  __pyx_v_m = (__pyx_v_h_ii.shape[0]);

  /* "recursive_sgf.pyx":41
 *     cdef int m = h_ii.shape[0], i, j
 *     cdef complex z
 *     z = energy - bias + eta * 1.j             # <<<<<<<<<<<<<<
 * 
 *     for j in prange(m, schedule='static'):
 */
  __pyx_v_z = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts((__pyx_v_energy - __pyx_v_bias), 0), __Pyx_c_prod_double(__pyx_t_double_complex_from_parts(__pyx_v_eta, 0), __pyx_t_double_complex_from_parts(0, 1.0)));

  /* "recursive_sgf.pyx":43
 *     z = energy - bias + eta * 1.j
 * 
 *     for j in prange(m, schedule='static'):             # <<<<<<<<<<<<<<
 *         for i in range(m):
 ...
 */
                        ...
                        __pyx_t_11 = __pyx_v_j;
                        __pyx_t_12 = __pyx_v_i;
                        *((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_00.data) + __pyx_t_11)) ) + __pyx_t_12 * __pyx_v_v_00.strides[1]) )) = __Pyx_c_diff_double(__Pyx_c_prod_double(__pyx_v_z, __pyx_f_13recursive_sgf_conj((*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s_ii.data + __pyx_t_7 * __pyx_v_s_ii.strides[0]) ) + __pyx_t_8 * __pyx_v_s_ii.strides[1]) ))))), __pyx_f_13recursive_sgf_conj((*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_h_ii.data + __pyx_t_9 * __pyx_v_h_ii.strides[0]) ) + __pyx_t_10 * __pyx_v_h_ii.strides[1]) )))));

                        /* "recursive_sgf.pyx":46
 *         for i in range(m):
 *             v_00[j,i] = z * conj(s_ii[i,j]) - conj(h_ii[i,j])
 *             v_11[j,i] = v_00[j,i]             # <<<<<<<<<<<<<<
 *             v_01[j,i] = z * conj(s_ij[i,j]) - conj(h_ij[i,j])
 ...
 */
                        ...
                        __pyx_t_8 = __pyx_v_j;
                        __pyx_t_7 = __pyx_v_i;
                        *((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_11.data) + __pyx_t_8)) ) + __pyx_t_7 * __pyx_v_v_11.strides[1]) )) = (*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_00.data) + __pyx_t_10)) ) + __pyx_t_9 * __pyx_v_v_00.strides[1]) )));

                        /* "recursive_sgf.pyx":47
 *             v_00[j,i] = z * conj(s_ii[i,j]) - conj(h_ii[i,j])
 *             v_11[j,i] = v_00[j,i]
 *             v_01[j,i] = z * conj(s_ij[i,j]) - conj(h_ij[i,j])             # <<<<<<<<<<<<<<
 * 
 ...
 */
                        ...
                        *((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_01.data) + __pyx_t_15)) ) + __pyx_t_16 * __pyx_v_v_01.strides[1]) )) = __Pyx_c_diff_double(__Pyx_c_prod_double(__pyx_v_z, __pyx_f_13recursive_sgf_conj((*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s_ij.data + __pyx_t_9 * __pyx_v_s_ij.strides[0]) ) + __pyx_t_10 * __pyx_v_s_ij.strides[1]) ))))), __pyx_f_13recursive_sgf_conj((*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_h_ij.data + __pyx_t_13 * __pyx_v_h_ij.strides[0]) ) + __pyx_t_14 * __pyx_v_h_ij.strides[1]) )))));
                      }
                  }
              }
          }
 ...
 */
  ...
  if ((1 == 0)) abort();
  {
      ...
      {
          #ifdef _OPENMP
          #pragma omp parallel private(__pyx_t_10, __pyx_t_13, __pyx_t_14, __pyx_t_17, __pyx_t_18, __pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_9)
          #endif /* _OPENMP */
          {
              #ifdef _OPENMP
              #pragma omp for lastprivate(__pyx_v_i) firstprivate(__pyx_v_j) lastprivate(__pyx_v_j) schedule(static)
 ...
 */
                        ...
                        *((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_10.data) + __pyx_t_17)) ) + __pyx_t_18 * __pyx_v_v_10.strides[1]) )) = __Pyx_c_diff_double(__Pyx_c_prod_double(__pyx_v_z, (*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s_ij.data + __pyx_t_14 * __pyx_v_s_ij.strides[0]) ) + __pyx_t_13 * __pyx_v_s_ij.strides[1]) )))), (*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_h_ij.data + __pyx_t_10 * __pyx_v_h_ij.strides[0]) ) + __pyx_t_9 * __pyx_v_h_ij.strides[1]) ))));
                      }
                  }
              }
          }
...
static void __pyx_f_13recursive_sgf_get_Ginv(__Pyx_memviewslice __pyx_v_v_00, __Pyx_memviewslice __pyx_v_v_01, __Pyx_memviewslice __pyx_v_v_10, __Pyx_memviewslice __pyx_v_v_11, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_lu, __Pyx_memviewslice __pyx_v_v_01_dot_b, __Pyx_memviewslice __pyx_v_ipiv) {
  int __pyx_v_m;
  int __pyx_v_info;
  char __pyx_v_trans;
  char __pyx_v_norm;
 ...
 */
  __pyx_v_m = (__pyx_v_v_00.shape[0]);

  /* "recursive_sgf.pyx":61
 * 
 *     cdef int m = v_00.shape[0], i, j, info
 *     cdef char trans = b'N', norm = b'M'             # <<<<<<<<<<<<<<
 *     cdef complex alpha = 1.+0.j, beta = -1.+0.j, gamma = 0.+0.j
 ...
 */
    __pyx_f_13recursive_sgf_mat_copy(__pyx_v_alpha, __pyx_v_v_11, __pyx_v_lu);
 ...
 */
    ...
    __pyx_t_3 = 0;
    __pyx_t_4 = 0;
    __pyx_f_5scipy_6linalg_13cython_lapack_zgetrf((&__pyx_v_m), (&__pyx_v_m), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_lu.data) + __pyx_t_2)) ) + __pyx_t_3 * __pyx_v_lu.strides[1]) )))), (&__pyx_v_m), (&(*((int *) ( /* dim=0 */ (__pyx_v_ipiv.data + __pyx_t_4 * __pyx_v_ipiv.strides[0]) )))), (&__pyx_v_info));

    /* "recursive_sgf.pyx":95
 *         zgetrf(&m,&m,&lu[0,0],&m,&ipiv[0],&info)
 *         # assert np.allclose(np.asarray(lu), py_lu), 'lu'
 *         mat_copy(alpha, v_01, a)             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_f_13recursive_sgf_mat_copy(__pyx_v_alpha, __pyx_v_v_01, __pyx_v_a);

    /* "recursive_sgf.pyx":97
 *         mat_copy(alpha, v_01, a)
 *         # assert np.allclose(np.asarray(a), py_v_01), 'comp a v_01'
 *         zgetrs(&trans,&m,&m,&lu[0,0],&m,&ipiv[0],&a[0,0],&m,&info);             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_5 = 0;
    __pyx_t_6 = 0;
    __pyx_f_5scipy_6linalg_13cython_lapack_zgetrs((&__pyx_v_trans), (&__pyx_v_m), (&__pyx_v_m), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_lu.data) + __pyx_t_4)) ) + __pyx_t_3 * __pyx_v_lu.strides[1]) )))), (&__pyx_v_m), (&(*((int *) ( /* dim=0 */ (__pyx_v_ipiv.data + __pyx_t_2 * __pyx_v_ipiv.strides[0]) )))), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_a.data) + __pyx_t_5)) ) + __pyx_t_6 * __pyx_v_a.strides[1]) )))), (&__pyx_v_m), (&__pyx_v_info));
 ...
 */
    __pyx_f_13recursive_sgf_mat_copy(__pyx_v_alpha, __pyx_v_v_10, __pyx_v_b);

    /* "recursive_sgf.pyx":100
 *         # assert np.allclose(np.asarray(a), py_a), 'a'
 *         mat_copy(alpha, v_10, b)
 *         zgetrs(&trans,&m,&m,&lu[0,0],&m,&ipiv[0],&b[0,0],&m,&info);             # <<<<<<<<<<<<<<
 *         # assert np.allclose(np.asarray(b), py_b) ,'b'
 ...
 */
    ...
    __pyx_t_3 = 0;
    __pyx_t_4 = 0;
    __pyx_f_5scipy_6linalg_13cython_lapack_zgetrs((&__pyx_v_trans), (&__pyx_v_m), (&__pyx_v_m), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_lu.data) + __pyx_t_6)) ) + __pyx_t_5 * __pyx_v_lu.strides[1]) )))), (&__pyx_v_m), (&(*((int *) ( /* dim=0 */ (__pyx_v_ipiv.data + __pyx_t_2 * __pyx_v_ipiv.strides[0]) )))), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_b.data) + __pyx_t_3)) ) + __pyx_t_4 * __pyx_v_b.strides[1]) )))), (&__pyx_v_m), (&__pyx_v_info));
 ...
 *         # assert np.allclose(np.asarray(v_01_dot_b), py_v_01_dot_b), 'v_01_dot_b'
 */
    __pyx_f_5scipy_6linalg_11cython_blas_zgemm((&__pyx_v_trans), (&__pyx_v_trans), (&__pyx_v_m), (&__pyx_v_m), (&__pyx_v_m), (&__pyx_v_alpha), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_01.data) + __pyx_t_4)) ) + __pyx_t_3 * __pyx_v_v_01.strides[1]) )))), (&__pyx_v_m), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_b.data) + __pyx_t_2)) ) + __pyx_t_5 * __pyx_v_b.strides[1]) )))), (&__pyx_v_m), (&__pyx_v_gamma), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_01_dot_b.data) + __pyx_t_6)) ) + __pyx_t_7 * __pyx_v_v_01_dot_b.strides[1]) )))), (&__pyx_v_m));
 ...
 */
    __pyx_f_13recursive_sgf_mat_add(__pyx_v_beta, __pyx_v_v_01_dot_b, __pyx_v_v_00);

    /* "recursive_sgf.pyx":107
 *         mat_add(beta, v_01_dot_b, v_00)
 *         # assert np.allclose(np.asarray(v_00), py_v_00), 'v_00'
 *         zgemm(&trans,&trans,&m,&m,&m,&beta,&v_10[0,0],&m,&a[0,0],             # <<<<<<<<<<<<<<
 *               &m,&alpha,&v_11[0,0],&m)
 ...
 *         # assert not np.allclose(np.asarray(v_11), py_v_11), 'v_11'
 */
    __pyx_f_5scipy_6linalg_11cython_blas_zgemm((&__pyx_v_trans), (&__pyx_v_trans), (&__pyx_v_m), (&__pyx_v_m), (&__pyx_v_m), (&__pyx_v_beta), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_10.data) + __pyx_t_7)) ) + __pyx_t_6 * __pyx_v_v_10.strides[1]) )))), (&__pyx_v_m), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_a.data) + __pyx_t_5)) ) + __pyx_t_2 * __pyx_v_a.strides[1]) )))), (&__pyx_v_m), (&__pyx_v_alpha), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_11.data) + __pyx_t_3)) ) + __pyx_t_4 * __pyx_v_v_11.strides[1]) )))), (&__pyx_v_m));
 ...
 */
    __pyx_f_13recursive_sgf_mat_add(__pyx_v_beta, __pyx_v_v_01_dot_b, __pyx_v_v_11);
 ...
 *               &m,&gamma,&v_01[0,0],&m)
 */
    __pyx_f_13recursive_sgf_mat_copy(__pyx_v_alpha, __pyx_v_v_01, __pyx_v_lu);

    /* "recursive_sgf.pyx":113
 *         # assert np.allclose(np.asarray(v_11), py_v_11), 'v_11'
 *         mat_copy(alpha, v_01, lu)
 *         zgemm(&trans,&trans,&m,&m,&m,&beta,&lu[0,0],&m,&a[0,0],             # <<<<<<<<<<<<<<
 *               &m,&gamma,&v_01[0,0],&m)
 ...
 *         # assert np.allclose(np.asarray(v_01), py_v_01), 'v_01'
 */
    __pyx_f_5scipy_6linalg_11cython_blas_zgemm((&__pyx_v_trans), (&__pyx_v_trans), (&__pyx_v_m), (&__pyx_v_m), (&__pyx_v_m), (&__pyx_v_beta), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_lu.data) + __pyx_t_4)) ) + __pyx_t_3 * __pyx_v_lu.strides[1]) )))), (&__pyx_v_m), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_a.data) + __pyx_t_2)) ) + __pyx_t_5 * __pyx_v_a.strides[1]) )))), (&__pyx_v_m), (&__pyx_v_gamma), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_01.data) + __pyx_t_6)) ) + __pyx_t_7 * __pyx_v_v_01.strides[1]) )))), (&__pyx_v_m));
 ...
 *               &m,&gamma,&v_10[0,0],&m)
 */
    __pyx_f_13recursive_sgf_mat_copy(__pyx_v_alpha, __pyx_v_v_10, __pyx_v_lu);

    /* "recursive_sgf.pyx":117
 *         # assert np.allclose(np.asarray(v_01), py_v_01), 'v_01'
 *         mat_copy(alpha, v_10, lu)
 *         zgemm(&trans,&trans,&m,&m,&m,&beta,&lu[0,0],&m,&b[0,0],             # <<<<<<<<<<<<<<
 *               &m,&gamma,&v_10[0,0],&m)
 ...
 *         # assert np.allclose(np.asarray(v_10), py_v_10), 'v_10'
 */
    __pyx_f_5scipy_6linalg_11cython_blas_zgemm((&__pyx_v_trans), (&__pyx_v_trans), (&__pyx_v_m), (&__pyx_v_m), (&__pyx_v_m), (&__pyx_v_beta), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_lu.data) + __pyx_t_7)) ) + __pyx_t_6 * __pyx_v_lu.strides[1]) )))), (&__pyx_v_m), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_b.data) + __pyx_t_5)) ) + __pyx_t_2 * __pyx_v_b.strides[1]) )))), (&__pyx_v_m), (&__pyx_v_gamma), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_10.data) + __pyx_t_3)) ) + __pyx_t_4 * __pyx_v_v_10.strides[1]) )))), (&__pyx_v_m));

    /* "recursive_sgf.pyx":120
 *               &m,&gamma,&v_10[0,0],&m)
 *         # assert np.allclose(np.asarray(v_10), py_v_10), 'v_10'
 *         delta = zlange(&norm,&m,&m,&v_01[0,0],&m,&work[0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_4 = 0;
    __pyx_t_3 = 0;
    __pyx_v_delta = __pyx_f_5scipy_6linalg_13cython_lapack_zlange((&__pyx_v_norm), (&__pyx_v_m), (&__pyx_v_m), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_v_01.data) + __pyx_t_4)) ) + __pyx_t_3 * __pyx_v_v_01.strides[1]) )))), (&__pyx_v_m), (&(__pyx_v_work[0])));
  }
...
static PyObject *__pyx_pw_13recursive_sgf_1get_G(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("get_G (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_H_kii)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_G", 0, 6, 8, 1); __PYX_ERR(0, 123, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_S_kii)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_G", 0, 6, 8, 2); __PYX_ERR(0, 123, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_H_kij)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_G", 0, 6, 8, 3); __PYX_ERR(0, 123, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_S_kij)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_G", 0, 6, 8, 4); __PYX_ERR(0, 123, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_energy)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_G", 0, 6, 8, 5); __PYX_ERR(0, 123, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_G") < 0)) __PYX_ERR(0, 123, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_eta = values[6];
    __pyx_v_bias = values[7];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_G", 0, 6, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 123, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_13recursive_sgf_get_G(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_G_kMM, PyObject *__pyx_v_H_kii, PyObject *__pyx_v_S_kii, PyObject *__pyx_v_H_kij, PyObject *__pyx_v_S_kij, PyObject *__pyx_v_energy, CYTHON_UNUSED PyObject *__pyx_v_eta, CYTHON_UNUSED PyObject *__pyx_v_bias) {
 ...
 *     n = G_kMM.shape[2]
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_H_kii, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 125, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_G_kMM, __pyx_n_s_shape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 126, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_t_2, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 126, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     # with nogil, parallel():
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_G_kMM, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 127, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_GetItemInt(__pyx_t_1, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 127, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_n = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "recursive_sgf.pyx":130
 * 
 *     # with nogil, parallel():
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_order, __pyx_n_u_F) < 0) __PYX_ERR(0, 130, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_order, __pyx_n_u_F) < 0) __PYX_ERR(0, 132, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 132, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_order, __pyx_n_u_F) < 0) __PYX_ERR(0, 135, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_order, __pyx_n_u_F) < 0) __PYX_ERR(0, 136, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 138, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_order, __pyx_n_u_F) < 0) __PYX_ERR(0, 138, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 139, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_int32); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 139, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = NULL;
  __pyx_t_5 = 0;
  ...
  if (PyFunction_Check(__pyx_t_3)) {
    ...
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_5, 2+__pyx_t_5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 139, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[3] = {__pyx_t_4, __pyx_v_m, __pyx_t_2};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_5, 2+__pyx_t_5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 139, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  } else
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_builtin_range, __pyx_v_nkpts); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 141, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  for (;;) {
    if (likely(!__pyx_t_8)) {
      if (likely(PyList_CheckExact(__pyx_t_3))) {
        ...
        __pyx_t_1 = PyList_GET_ITEM(__pyx_t_3, __pyx_t_7); __Pyx_INCREF(__pyx_t_1); __pyx_t_7++; if (unlikely(0 < 0)) __PYX_ERR(0, 141, __pyx_L1_error)
        #else
        __pyx_t_1 = PySequence_ITEM(__pyx_t_3, __pyx_t_7); __pyx_t_7++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 141, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        #endif
      } else {
        if (__pyx_t_7 >= PyTuple_GET_SIZE(__pyx_t_3)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_1 = PyTuple_GET_ITEM(__pyx_t_3, __pyx_t_7); __Pyx_INCREF(__pyx_t_1); __pyx_t_7++; if (unlikely(0 < 0)) __PYX_ERR(0, 141, __pyx_L1_error)
        #else
        __pyx_t_1 = PySequence_ITEM(__pyx_t_3, __pyx_t_7); __pyx_t_7++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 141, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        #endif
 ...
 */
    __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_v_H_kii, __pyx_v_i); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 142, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dsds___pyx_t_double_complex(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 142, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_v_S_kii, __pyx_v_i); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 142, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dsds___pyx_t_double_complex(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 142, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_v_H_kij, __pyx_v_i); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 142, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dsds___pyx_t_double_complex(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 142, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_v_S_kij, __pyx_v_i); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 142, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_dsds___pyx_t_double_complex(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_12.memview)) __PYX_ERR(0, 142, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
    __pyx_t_13 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_00, PyBUF_WRITABLE); if (unlikely(!__pyx_t_13.memview)) __PYX_ERR(0, 143, __pyx_L1_error)
    __pyx_t_14 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_01, PyBUF_WRITABLE); if (unlikely(!__pyx_t_14.memview)) __PYX_ERR(0, 143, __pyx_L1_error)
    __pyx_t_15 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_10, PyBUF_WRITABLE); if (unlikely(!__pyx_t_15.memview)) __PYX_ERR(0, 143, __pyx_L1_error)
    __pyx_t_16 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_11, PyBUF_WRITABLE); if (unlikely(!__pyx_t_16.memview)) __PYX_ERR(0, 143, __pyx_L1_error)
    __pyx_t_17 = __pyx_PyFloat_AsDouble(__pyx_v_energy); if (unlikely((__pyx_t_17 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 143, __pyx_L1_error)
 ...
 *       get_Ginv(v_00,v_01,v_10,v_11,
 */
    __pyx_f_13recursive_sgf_init_vecs(__pyx_t_9, __pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, NULL);
 ...
 */
    __pyx_t_16 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_00, PyBUF_WRITABLE); if (unlikely(!__pyx_t_16.memview)) __PYX_ERR(0, 144, __pyx_L1_error)
    __pyx_t_15 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_01, PyBUF_WRITABLE); if (unlikely(!__pyx_t_15.memview)) __PYX_ERR(0, 144, __pyx_L1_error)
    __pyx_t_14 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_10, PyBUF_WRITABLE); if (unlikely(!__pyx_t_14.memview)) __PYX_ERR(0, 144, __pyx_L1_error)
    __pyx_t_13 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_11, PyBUF_WRITABLE); if (unlikely(!__pyx_t_13.memview)) __PYX_ERR(0, 144, __pyx_L1_error)

    /* "recursive_sgf.pyx":145
 *                 v_00,v_01,v_10,v_11,energy)
 *       get_Ginv(v_00,v_01,v_10,v_11,
 *                a,b,lu,v_01_dot_b,ipiv)             # <<<<<<<<<<<<<<
 *       G_kMM[i] = la.inv(v_00)#, overwrite_a=True, check_finite=False)
 */
    __pyx_t_18 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_a, PyBUF_WRITABLE); if (unlikely(!__pyx_t_18.memview)) __PYX_ERR(0, 145, __pyx_L1_error)
    __pyx_t_19 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_b, PyBUF_WRITABLE); if (unlikely(!__pyx_t_19.memview)) __PYX_ERR(0, 145, __pyx_L1_error)
    __pyx_t_20 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_lu, PyBUF_WRITABLE); if (unlikely(!__pyx_t_20.memview)) __PYX_ERR(0, 145, __pyx_L1_error)
    __pyx_t_21 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_01_dot_b, PyBUF_WRITABLE); if (unlikely(!__pyx_t_21.memview)) __PYX_ERR(0, 145, __pyx_L1_error)
    __pyx_t_22 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_ipiv, PyBUF_WRITABLE); if (unlikely(!__pyx_t_22.memview)) __PYX_ERR(0, 145, __pyx_L1_error)
 ...
 *       G_kMM[i] = la.inv(v_00)#, overwrite_a=True, check_finite=False)
 */
    __pyx_f_13recursive_sgf_get_Ginv(__pyx_t_16, __pyx_t_15, __pyx_t_14, __pyx_t_13, __pyx_t_18, __pyx_t_19, __pyx_t_20, __pyx_t_21, __pyx_t_22);
    __PYX_XDEC_MEMVIEW(&__pyx_t_16, 1);
    __pyx_t_16.memview = NULL;
    __pyx_t_16.data = NULL;
    __PYX_XDEC_MEMVIEW(&__pyx_t_15, 1);
    ...
    /* "recursive_sgf.pyx":146
 *       get_Ginv(v_00,v_01,v_10,v_11,
 *                a,b,lu,v_01_dot_b,ipiv)
 *       G_kMM[i] = la.inv(v_00)#, overwrite_a=True, check_finite=False)             # <<<<<<<<<<<<<<
 */
    __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_n_s_la); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 146, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_inv); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 146, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = NULL;
    ...
    __pyx_t_1 = (__pyx_t_6) ? __Pyx_PyObject_Call2Args(__pyx_t_2, __pyx_t_6, __pyx_v_v_00) : __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_v_v_00);
    __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
    if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 146, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (unlikely(PyObject_SetItem(__pyx_v_G_kMM, __pyx_v_i, __pyx_t_1) < 0)) __PYX_ERR(0, 146, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     nkpts = H_kii.shape[0]
 */
  __pyx_tuple__19 = PyTuple_Pack(21, __pyx_n_s_G_kMM, __pyx_n_s_H_kii, __pyx_n_s_S_kii, __pyx_n_s_H_kij, __pyx_n_s_S_kij, __pyx_n_s_energy, __pyx_n_s_eta, __pyx_n_s_bias, __pyx_n_s_nkpts, __pyx_n_s_m, __pyx_n_s_n, __pyx_n_s_v_00, __pyx_n_s_v_11, __pyx_n_s_v_10, __pyx_n_s_v_01, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_lu, __pyx_n_s_v_01_dot_b, __pyx_n_s_ipiv, __pyx_n_s_i); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(8, 0, 21, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_recursive_sgf_pyx, __pyx_n_s_get_G, 123, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 123, __pyx_L1_error)
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  if (__Pyx_ImportFunction(__pyx_t_2, "zgemm", (void (**)(void))&__pyx_f_5scipy_6linalg_11cython_blas_zgemm, "void (char *, char *, int *, int *, int *, __pyx_t_double_complex *, __pyx_t_double_complex *, int *, __pyx_t_double_complex *, int *, __pyx_t_double_complex *, __pyx_t_double_complex *, int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 *     nkpts = H_kii.shape[0]
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_13recursive_sgf_1get_G, NULL, __pyx_n_s_recursive_sgf); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_get_G, __pyx_t_2) < 0) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
