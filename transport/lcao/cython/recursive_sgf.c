...
static PyObject *__pyx_pf_13recursive_sgf_get_G(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_G_kMM, PyObject *__pyx_v_H_kii, PyObject *__pyx_v_S_kii, PyObject *__pyx_v_H_kij, PyObject *__pyx_v_S_kij, PyObject *__pyx_v_energy, CYTHON_UNUSED double __pyx_v_eta, CYTHON_UNUSED double __pyx_v_bias); /* proto */
...
static PyObject *__pyx_pf_13recursive_sgf_get_G(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_G_kMM, PyObject *__pyx_v_H_kii, PyObject *__pyx_v_S_kii, PyObject *__pyx_v_H_kij, PyObject *__pyx_v_S_kij, PyObject *__pyx_v_energy, CYTHON_UNUSED double __pyx_v_eta, CYTHON_UNUSED double __pyx_v_bias) {
 ...
 */
    __pyx_t_24 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_a, PyBUF_WRITABLE); if (unlikely(!__pyx_t_24.memview)) __PYX_ERR(0, 165, __pyx_L1_error)
    __pyx_t_25 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_b, PyBUF_WRITABLE); if (unlikely(!__pyx_t_25.memview)) __PYX_ERR(0, 165, __pyx_L1_error)
    __pyx_t_26 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_lu, PyBUF_WRITABLE); if (unlikely(!__pyx_t_26.memview)) __PYX_ERR(0, 165, __pyx_L1_error)
    __pyx_t_27 = __Pyx_PyObject_to_MemoryviewSlice_dcd____pyx_t_double_complex(__pyx_v_v_01_dot_b, PyBUF_WRITABLE); if (unlikely(!__pyx_t_27.memview)) __PYX_ERR(0, 165, __pyx_L1_error)
    __pyx_t_28 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_ipiv, PyBUF_WRITABLE); if (unlikely(!__pyx_t_28.memview)) __PYX_ERR(0, 165, __pyx_L1_error)
 ...
 *         inv(&_v_00[0,0],work,ipiv,m)
 */
    __pyx_f_13recursive_sgf_get_Ginv((&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v__v_00.data + __pyx_t_22 * __pyx_v__v_00.strides[0]) ) + __pyx_t_21 * __pyx_v__v_00.strides[1]) )))), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v__v_01.data + __pyx_t_20 * __pyx_v__v_01.strides[0]) ) + __pyx_t_19 * __pyx_v__v_01.strides[1]) )))), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v__v_10.data + __pyx_t_18 * __pyx_v__v_10.strides[0]) ) + __pyx_t_17 * __pyx_v__v_10.strides[1]) )))), (&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v__v_11.data + __pyx_t_16 * __pyx_v__v_11.strides[0]) ) + __pyx_t_15 * __pyx_v__v_11.strides[1]) )))), __pyx_t_24, __pyx_t_25, __pyx_t_26, __pyx_t_27, __pyx_t_28, __pyx_t_6);
 ...
 */
    __pyx_t_15 = 0;
    __pyx_t_16 = 0;
    __pyx_t_29 = __Pyx_PyObject_to_MemoryviewSlice_dc___pyx_t_double_complex(__pyx_v_work, PyBUF_WRITABLE); if (unlikely(!__pyx_t_29.memview)) __PYX_ERR(0, 166, __pyx_L1_error)
    __pyx_t_28 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_ipiv, PyBUF_WRITABLE); if (unlikely(!__pyx_t_28.memview)) __PYX_ERR(0, 166, __pyx_L1_error)
    __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_v_m); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 166, __pyx_L1_error)
    __pyx_f_13recursive_sgf_inv((&(*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v__v_00.data + __pyx_t_15 * __pyx_v__v_00.strides[0]) ) + __pyx_t_16 * __pyx_v__v_00.strides[1]) )))), __pyx_t_29, __pyx_t_28, __pyx_t_6);
